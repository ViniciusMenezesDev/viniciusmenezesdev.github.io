...
{{< image src="/files/2012/07/jboss_as_01.jpg" >}}
...
É necessário que o Java Development Kit (JDK) esteja instalado no computador para que o JBoss AS possa ser executado. Também é importante que a variável de ambiente JAVA_HOME esteja configurada, o JBoss AS obtém o valor dessa variável e o utiliza para saber a localização do JDK no sistema. Se precisar de ajuda com relação a isso, leia [esse outro post]({{% ref "2012-07-10-instalacao-do-java-development-kit-jdk" %}}), no qual explico como instalar e testar o JDK.

Precisaremos também do Maven, que já foi abordado em [outro post]({{% ref "2012-07-18-instalacao-do-apache-maven" %}}). Ele não é necessário à execução do JBoss AS, mas precisaremos dele nesse passo-a-passo para implantar uma aplicação de exemplo no servidor.
...
{{< image src="/files/2012/07/jboss_as_02.jpg" >}}
...
{{< image src="/files/2012/07/jboss_as_03.jpg" >}}
...
{{< image src="/files/2012/07/jboss_as_04.jpg" >}}
...
Também podemos fazer deploy e undeploy de aplicações no servidor, entre outras configurações, usando o console de administração do JBoss AS. Examinaremos esse console na [segunda parte desse post]({{% ref "2012-07-18-apresentando-o-servidor-de-aplicacao-jboss-as-7-parte-2" %}}).
...
[VPN]:                  {{% ref "2024-09-03-o-que-e-vpn-e-a-forma-mais-facil-de-usa-la-no-windows-por-meio-do-navegador-tor" %}}
[Windows]:              https://www.microsoft.com/pt-br/windows/
[Mozilla Firefox]:      https://www.mozilla.org/pt-BR/firefox/
[telegram-tor]:         {{% ref "2022-03-23-como-usar-o-telegram-via-tor-no-windows" %}}

...
Meu *site* utiliza [jQuery](https://jquery.com/) e [Bootstrap](http://getbootstrap.com/) (veja o [*post* sobre Bootstrap]({{% ref "2015-07-02-bootstrap" %}})). Eu simplesmente adicionei as seguintes linhas de código ao arquivo JavaScript que é carregado em todas as páginas do *site*:

...
excerpt: 'Eu fico indignado com páginas que demoram pra carregar devido ao tamanho
  das imagens. Não o tamanho que elas aparentam ter na página, mas o tamanho que elas
  realmente tem: muitas vezes na página a imagem ocupa um espaço pequeno, mas como
...
[dicas-prints]:     {{% ref "2016-02-18-dicas-para-bater-bons-prints" %}}

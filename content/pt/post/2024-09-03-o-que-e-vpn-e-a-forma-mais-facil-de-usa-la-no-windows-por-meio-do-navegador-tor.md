...
excerpt: Entenda o que é VPN, porque usá-la, conheça a Rede Tor e veja como instalar
  e usar o Navegador Tor no Windows.
image: /files/2024/09/tor-browser-windows.jpg
title: 'O que é VPN e a forma mais fácil de usá-la no Windows: por meio do Navegador
  Tor'
---
...
- iOS (iPhone e iPad): [O que é VPN e a forma mais fácil de usá-la no iOS: por meio do app Orbot]({{% ref "2024-09-03-o-que-e-vpn-e-a-forma-mais-facil-de-usa-la-no-ios-por-meio-do-app-orbot" %}})
...
## Baixando e instalando o Navegador Tor

Para baixar o Navegador Tor, acesse o _site_ oficial do Projeto Tor e clique em **Download para Windows**:
...
Quando você instala o Navegador Tor no Windows, ele é iniciado automaticamente pelo instalador para que seja usado pela primeira vez.

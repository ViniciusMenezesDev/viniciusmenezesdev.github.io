...
{{< image src="/files/2012/07/jboss_as_mysql_01.jpg" >}}
...
No [post anterior]({{% ref "2012-07-18-apresentando-o-servidor-de-aplicacao-jboss-as-7" %}}), você foi apresentado ao JBoss AS. Nesse post, veremos como configurar nele uma conexão com o MySQL, e veremos também como configurar uma aplicação Java EE para utilizar essa conexão. Para fins didáticos, vou supor que você possui o JBoss AS e o MySQL instalados em seu computador, e que você criou uma base de dados chamada “teste” (para esse passo-a-passo a estrutura da base de dados não é importante, focaremos na conexão).
...
Quando o conteúdo do arquivo é extraído, é criada uma pasta “mysql-connector-java-5.1.21″. Dentro dessa pasta, está o arquivo “mysql-connector-java-5.1.21-bin.jar”. Implante esse arquivo no servidor utilizando o console Web de administração do JBoss AS, exatamente como descrito na [segunda parte do post anterior]({{% ref "2012-07-18-apresentando-o-servidor-de-aplicacao-jboss-as-7-parte-2" %}}).

Ao final do processo, o driver JDBC do MySQL deve aparecer habilitado na lista de aplicações implantadas, como mostra a figura (curiosamente, a [aplicação de exemplo](http://www.jboss.org/jdf/quickstarts/jboss-as-quickstart/helloworld-jsf/) que implantamos [naquele post]({{% ref "2012-07-18-apresentando-o-servidor-de-aplicacao-jboss-as-7-parte-2" %}}) ainda está no servidor):

{{< image src="/files/2012/07/jboss_as_mysql_02.jpg" >}}
...
{{< image src="/files/2012/07/jboss_as_mysql_03.jpg" >}}
...
{{< image src="/files/2012/07/jboss_as_mysql_04.jpg" >}}
...
{{< image src="/files/2012/07/jboss_as_mysql_05.jpg" >}}
...
{{< image src="/files/2012/07/jboss_as_mysql_06.jpg" >}}

O datasource é criado e passa a aparecer na lista, mas ainda não está habilitado:

{{< image src="/files/2012/07/jboss_as_mysql_07.jpg" >}}
...
{{< image src="/files/2012/07/jboss_as_mysql_08.jpg" >}}

Marque as duas últimas opções e clique em “Save”:

{{< image src="/files/2012/07/jboss_as_mysql_09.jpg" >}}

Agora a JTA está habilitada:

{{< image src="/files/2012/07/jboss_as_mysql_10.jpg" >}}
...
{{< image src="/files/2012/07/jboss_as_mysql_11.jpg" >}}
...
{{< image src="/files/2012/07/jboss_as_mysql_12.jpg" >}}

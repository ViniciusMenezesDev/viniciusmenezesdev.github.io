...
O Bootstrap é um *framework* para o desenvolvimento de *sites* e aplicações *web* responsivos e foi apresentado no [*post* anterior]({{% ref "2015-07-02-bootstrap" %}}).
...
Por último, vamos rever nossos arquivos `header.php`, `index.php` e `footer.php` de modo que tenhamos uma `div.container` em volta do conteúdo, [como manda o Bootstrap]({{% ref "2015-07-02-bootstrap" %}}). Ao final, eles devem ficar assim (você pode ver as mudanças destacadas [aqui](https://github.com/vinyanalista/wpbootstrap/commit/c5c456b119200ce82b6ce6d5b56b6be9ae05bb0b)):
...
{% capture mensagem_2a_parte %}A segunda parte do tutorial já se encontra disponível [aqui]({{% ref "2015-08-20-wordpress-bootstrap-parte2" %}}).{% endcapture %}

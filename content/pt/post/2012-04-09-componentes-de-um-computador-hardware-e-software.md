...
{% capture mensagem_novo_post %}Agora que você já conhece os componentes básicos dos computadores, que tal aprender [como escolher um bom computador para comprar]({{% ref "2015-11-27-como-escolher-um-bom-computador-para-comprar" %}})?{% endcapture %}
{% include update.html date="27/11/2015" message=mensagem_novo_post %}

### Referências

Como esse post é uma parte (na verdade, o resumo de uma parte) da [minha pesquisa científica sobre processadores]({{% ref "2012-04-08-minha-pesquisa-cientifica-sobre-processadores" %}}), pode-se dizer que utiliza as mesmas referências dela. Em especial, posso citar esses livros:

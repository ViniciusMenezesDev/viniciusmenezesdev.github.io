---
date: "2021-06-17T10:40:00Z"
excerpt: Se você usa um dispositivo com iOS (um iPhone ou um iPad) e deseja conectá-lo
  à VPN do roteador MikroTik que configuramos em um post anterior, siga as instruções
  desse texto.
...
{{< image src="/files/2021/06/ios-vpn-01.jpg" >}}

{% include ad1.html %}

Toque em **Adicionar Configuração de VPN**:

{{< image src="/files/2021/06/ios-vpn-02.jpg" >}}
...
{{< image src="/files/2021/06/ios-vpn-03.jpg" >}}
...
{{< image src="/files/2021/06/ios-vpn-04.jpg" >}}
...
{{< image src="/files/2021/06/ios-vpn-05.jpg" >}}
...
{{< image src="/files/2021/06/ios-vpn-06.jpg" >}}
...
{{< image src="/files/2021/06/ios-vpn-07.jpg" >}}

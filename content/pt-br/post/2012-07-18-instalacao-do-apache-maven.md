...
É necessário prestar atenção a esse local pois, assim como fizemos na [instalação do JDK]({{% ref "2012-07-10-instalacao-do-java-development-kit-jdk" %}}), aqui vamos configurar uma variável de ambiente que aponte para a localização do Maven, chamada de M2_HOME.

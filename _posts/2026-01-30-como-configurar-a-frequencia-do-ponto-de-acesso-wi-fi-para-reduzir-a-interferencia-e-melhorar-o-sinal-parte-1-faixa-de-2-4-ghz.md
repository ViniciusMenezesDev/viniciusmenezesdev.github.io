---
date: '2026-01-30 20:00:00 GMT-3'
layout: post
published: true
...
{% include image.html src="/files/2026/01/wifi-analyzer.jpg" %}
...
{% include image.html src="/files/2026/01/evolucao-wifi.webp" caption="Evolução das redes Wi-Fi. Crédito da imagem: [Ubiquiti Brasil](https://medium.com/ubntbr/planejamento-de-canais-em-wlan-wifi-como-fazer-673233cccc6f)." %}
...
{% include image.html src="/files/2025/11/mikrotik-hap-ac3.jpg" caption="Roteador Wi-Fi MikroTik hAP ac³" %}
...
{% include image.html src="/files/2026/01/canais-2-ghz-gabrielricce.webp" caption="Canais da faixa de 2,4 GHz. Crédito da imagem: [Gabriel Ricce](https://medium.com/@gabrielricce/bem-vindos-amigos-ao-segundo-post-deste-blog-e-o-primeiro-com-um-conte%C3%BAdo-tecnico-pra-variar-29e42372cfc4)." %}

{% include image.html src="/files/2026/01/canais-2-ghz-wlanpros.png" caption="Canais da faixa de 2,4 GHz. Crédito da imagem: [Wireless LAN Professionals](https://d2cpnw0u24fjm4.cloudfront.net/wp-content/uploads/Wi-Fi-Channel-Allocations-5GHz-and-2.4GHz-WLAN-Pros.pdf)." %}
...
{% include image.html src="/files/2026/01/wifi-analyzer-01.jpg" %}
...
{% include image.html src="/files/2026/01/wifi-analyzer-02.jpg" %}
...
{% include image.html src="/files/2026/01/wifi-analyzer-03.jpg" %}
...
{% include image.html src="/files/2026/01/wifi-analyzer-04.jpg" caption="Gráfico da faixa de 2,4 GHz" %}
...
{% include image.html src="/files/2026/01/wifi-analyzer-05.jpg" caption="Avaliação da faixa de 2,4 GHz" %}
...
{% include image.html src="/files/2026/01/mikrotik-wifi-01.png" %}
...
{% include image.html src="/files/2026/01/mikrotik-wifi-02.png" %}
...
{% include image.html src="/files/2026/01/mikrotik-wifi-03.png" %}
...
{% include image.html src="/files/2026/01/mikrotik-wifi-04.png" %}
...
{% include image.html src="/files/2026/01/mikrotik-wifi-05.png" %}
...
<div class="row">
    <div class="col-md">
        {% include image.html src="/files/2026/01/wifi-analyzer-06.jpg" caption="Gráfico da faixa de 2,4 GHz (depois)" %}
    </div>
    <div class="col-md">
        {% include image.html src="/files/2026/01/wifi-analyzer-07.jpg" caption="Mais informações sobre a rede de 2,4 GHz" %}
    </div>
</div>
...
<div class="row">
    <div class="col-md">
        {% include image.html src="/files/2026/01/sinal-2-ghz-antes.png" caption="Sinal da rede de 2,4 GHz (antes)" %}
    </div>
    <div class="col-md">
        {% include image.html src="/files/2026/01/sinal-2-ghz-depois.png" caption="Sinal da rede de 2,4 GHz (depois)" %}
    </div>
</div>
...
[parte 2]:              {% post_url 2026-01-30-como-configurar-a-frequencia-do-ponto-de-acesso-wi-fi-para-reduzir-a-interferencia-e-melhorar-o-sinal-parte-2-faixa-de-5-ghz %}
---
date: '2025-12-05 19:50:00 GMT-3'
layout: post
published: true
...
{% include image.html src="/files/2025/12/mikrotik-backup-01.png" %}

A janela **File List** lista os arquivos e pastas na memória interna do MikroTik:

{% include image.html src="/files/2025/12/mikrotik-backup-02.png" %}
...
{% include image.html src="/files/2025/12/mikrotik-backup-03.png" %}
...
{% include image.html src="/files/2025/12/mikrotik-backup-04.png" %}

Indique onde salvar o arquivo no seu computador:

{% include image.html src="/files/2025/12/mikrotik-backup-05.png" %}
...
{% include image.html src="/files/2025/12/mikrotik-backup-script-01.png" %}
...
{% include image.html src="/files/2025/12/mikrotik-backup-script-02.png" %}

Vá em **Files** novamente e perceba que foi gerado um arquivo chamado `backup.rsc`:

{% include image.html src="/files/2025/12/mikrotik-backup-script-03.png" %}
...
{% include image.html src="/files/2025/12/mikrotik-backup-script-04.png" %}
...
{% include image.html src="/files/2025/12/mikrotik-gitk.png" %}
...
[mikrotik-reset]:       {% post_url 2025-11-30-mikrotik-como-restaurar-a-configuracao-de-fabrica %}

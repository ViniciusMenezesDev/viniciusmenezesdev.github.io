---
date: '2022-03-23 21:40:00 GMT-3'
...
Se, por um acaso, você procurava instruções para outro sistema operacional, consulte os _links_ a seguir:

- Como usar o Telegram via Tor no Linux: consulte o tutorial no _site_ do Linux Kamarada:
  - [Dica: como usar o Telegram via Tor - Linux Kamarada][linux]

---
date: '2025-11-25 08:20:00 GMT-3'
layout: post
published: true
...
{% include image.html src="/files/2025/11/mikrotik-update-01.png" %}

Na janela **Package List**, clique no botão **Check For Updates**:

{% include image.html src="/files/2025/11/mikrotik-update-02.png" %}

Clique no botão **Download&Install**:

{% include image.html src="/files/2025/11/mikrotik-update-03.png" %}
...
{% include image.html src="/files/2025/11/mikrotik-update-04.png" %}
...
{% include image.html src="/files/2025/11/mikrotik-update-05.png" %}

Na janela de confirmação que pergunta **Do you really want to upgrade firmware?** confirme clicando em **Yes**:

{% include image.html src="/files/2025/11/mikrotik-update-06.png" %}
...
{% include image.html src="/files/2025/11/mikrotik-update-07.png" %}
...
{% include image.html src="/files/2025/11/mikrotik-update-08.png" %}
...
{% include image.html src="/files/2025/11/mikrotik-update-09.png" %}
...
[mikrotik-vpn]:     {% post_url 2021-04-09-mikrotik-como-criar-uma-vpn-com-l2tp-e-ipsec %}

---
date: '2026-03-25 22:00:00 GMT-3'
layout: post
published: true
...
{% include image.html src="/files/2026/03/github-copilot-pt.jpg" %}
...
{% include image.html src="/files/2026/03/github-copilot-01-pt.jpg" caption="Dependendo do modelo de celular, o nome do arquivo não contém a data da foto, é preciso examinar os metadados." %}
...
{% include image.html src="/files/2026/03/github-copilot-02-pt.png" %}
...
{% include image.html src="/files/2026/03/github-copilot-03-pt.png" %}
...
{% include image.html src="/files/2026/03/github-copilot-04-pt.jpg" %}
...
{% include image.html src="/files/2026/03/github-copilot-05-pt.png" %}

A pasta de fotos que antes estava assim:

{% include image.html src="/files/2026/03/github-copilot-06-pt.jpg" %}

Após a execução do _script_, passa a estar assim:

{% include image.html src="/files/2026/03/github-copilot-07-pt.png" %}

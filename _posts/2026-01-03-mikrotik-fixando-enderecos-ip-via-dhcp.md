---
date: '2026-01-03 21:30:00 GMT-3'
layout: post
published: true
...
{% include image.html src="/files/2026/01/mikrotik-dhcp-01.png" %}

Na janela **DHCP Server**, mude para a aba **Leases** (concessões):

{% include image.html src="/files/2026/01/mikrotik-dhcp-02.png" %}
...
{% include image.html src="/files/2026/01/mikrotik-dhcp-03.png" %}
...
{% include image.html src="/files/2026/01/mikrotik-dhcp-04.png" %}

Informe o endereço MAC (**MAC Address**) do dispositivo, o endereço IP (**Address**) que ele deve receber e clique em **OK**:

{% include image.html src="/files/2026/01/mikrotik-dhcp-05.png" %}
...
{% include image.html src="/files/2026/01/mikrotik-dhcp-06.png" %}

Digite algo para identificar essa concessão e clique em **OK**:

{% include image.html src="/files/2026/01/mikrotik-dhcp-07.png" %}

Repita isso para cada um dos dispositivos cadastrados:

{% include image.html src="/files/2026/01/mikrotik-dhcp-08.png" %}
...
{% include image.html src="/files/2026/01/mikrotik-dhcp-09.png" %}
...
{% include image.html src="/files/2026/01/mikrotik-dhcp-10.png" %}
...
{% include image.html src="/files/2026/01/mikrotik-dhcp-11.png" %}

[DHCP]:                 https://pt.wikipedia.org/wiki/Dynamic_Host_Configuration_Protocol
[DNS]:                  {% post_url 2025-12-30-mikrotik-como-configurar-o-dns %}
...
[backup]:               {% post_url 2025-12-05-mikrotik-como-exportar-e-fazer-backup-da-configuracao %}

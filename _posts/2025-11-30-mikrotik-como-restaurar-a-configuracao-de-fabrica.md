---
date: '2025-11-30 22:45:00 GMT-3'
layout: post
published: true
...
{% include image.html src="/files/2025/11/mikrotik-reset-button.jpg" %}
...
{% include image.html src="/files/2025/11/mikrotik-reset-01.png" %}

Clique no botão **Reset Configuration**:

{% include image.html src="/files/2025/11/mikrotik-reset-02.png" %}

Na janela de confirmação, clique em **Yes**:

{% include image.html src="/files/2025/11/mikrotik-reset-03.png" %}
...
{% include image.html src="/files/2025/11/mikrotik-reset-07.png" %}
...
[atualizações]:     {% post_url 2025-11-25-mikrotik-como-atualizar-o-software-do-roteador %}

---
date: '2025-12-30 02:00:00 GMT-3'
layout: post
published: true
...
{% include image.html src="/files/2025/12/mikrotik-dns-01.png" %}

Faça um duplo-clique na primeira e única interface listada e, na janela seguinte, desmarque a opção **Use Peer DNS**:

{% include image.html src="/files/2025/12/mikrotik-dns-02.png" %}
...
{% include image.html src="/files/2025/12/mikrotik-dns-03.png" %}
...
{% include image.html src="/files/2025/12/mikrotik-dns-04.png" %}
...
{% include image.html src="/files/2025/12/mikrotik-dns-05.png" %}
...
{% include image.html src="/files/2025/12/mikrotik-dns-06.png" %}
...
{% include image.html src="/files/2025/12/mikrotik-dns-07.png" %}
